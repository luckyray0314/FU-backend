...
export class FollowUpDataController {
  constructor(public service: FollowUpDataService) {}
  ...
  async create(@Body() payload: FollowUpDataDto): Promise<boolean> {
    return await this.service.create(payload);
  }

  @Get('/get/:codeNumber')
  @ApiOkResponse({ type: FollowUpDataDto })
  async get(@Param('codeNumber') codeNumber: string): Promise<FollowUpDataDto> {
